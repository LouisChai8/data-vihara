import { loginUser, registerUser } from "../api/anggota";
    ...
    <div>
      ...
      <div style={{ position: "relative" }}>
        <input
          ...
          onBlur={(e) =>
            (e.target.style.borderColor = error ? "#c87e7e" : "#1e2235")
          }
        />
        {rightElement && (
          <div
...
export default function AuthModal({ onClose, onLoginSuccess }) {
  ...
  const validateLogin = () => {
    ...
    if (!loginEmail.trim()) e.loginEmail = "Email wajib diisi";
      ...
      e.loginEmail = "Format email tidak valid";
  ...
  const validateSignup = () => {
    ...
    if (!signupEmail.trim()) e.signupEmail = "Email wajib diisi";
      ...
      e.signupEmail = "Format email tidak valid";
    if (!signupPass.trim()) e.signupPass = "Password wajib diisi";
    else if (signupPass.length < 6)
      e.signupPass = "Password minimal 6 karakter";
    if (!signupConfirm.trim())
      e.signupConfirm = "Konfirmasi password wajib diisi";
    else if (signupConfirm !== signupPass)
      e.signupConfirm = "Password tidak cocok";
    setErrors(e);
    return Object.keys(e).length === 0;
  };
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      showToast("success", `Selamat datang kembali, ${user.nama}!`);
      setTimeout(() => {
  ...
  return (
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "20px",
            boxShadow:
              "0 40px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(200,169,110,0.06)",
            overflow: "hidden",
        ...
        >
          ...
          <div
            style={{
              height: "3px",
              background:
                "linear-gradient(90deg, #c8a96e, #a07840, transparent)",
            }}
          />
              ...
              <div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      style={{ fontSize: "10px", color: "#454860", margin: 0 }}
                    >
                      Manajemen User
                    </p>
                  </div>
      ...
      {toast && (
        ...
        >
          {toast.type === "success" ? (
            <CheckCircle size={16} color="#7ec8a0" />
          ) : (
            <AlertCircle size={16} color="#c87e7e" />
          )}
          <p
            style={{
              fontSize: "13px",
